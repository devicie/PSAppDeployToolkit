...
namespace PSAppDeployToolkit.CodeGen
{
    ...
    internal sealed class PowerShellSyntaxWriter(string indentChars = "    ")
    {
        ...
        /// </param>
        internal void WriteStartHashtable(bool ordered = false)
        {
        ...
        /// </summary>
        internal void WriteArraySeparator()
        {
            _ = _buffer.Append(", ");
        }
        ...
        internal void WriteStringValue(string value)
        {
        ...
        internal void WriteRawValue(string raw)
        {
        ...
        /// <summary>
        /// Appends indentation characters to the internal buffer based on the current depth level.
        /// </summary>
        /// <remarks>This method is typically used to maintain proper formatting when generating
        /// structured text output, such as JSON or XML. The number of indentation levels is determined by the current
        /// value of the depth field.</remarks>
